...
General CTMCs do not have a closed-form stationary distributions but here we propose a class of CTMC useful for animal movement modeling for which we can directly evaluate the stationary distribution. The movement rates of this class has the form, 
\begin{equation}
\label{eq:rate}
